Trestle.configure do |config|
  ...
  #
   config.footer = "Desarrollado por: Camilo Bastidas"
  ...
  #  automatically mount the admin within your
  # efaults to true.
  # 
  ...
  #   end
 # <%= link_to "Cerrar Sesión", destroy_session_path(resource_name) %>
